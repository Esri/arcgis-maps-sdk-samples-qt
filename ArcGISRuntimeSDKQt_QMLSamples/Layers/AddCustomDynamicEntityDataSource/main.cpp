...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QString("AddCustomDynamicEntityDataSource - QML"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Layers/AddCustomDynamicEntityDataSource/AddCustomDynamicEntityDataSource.qml"));
