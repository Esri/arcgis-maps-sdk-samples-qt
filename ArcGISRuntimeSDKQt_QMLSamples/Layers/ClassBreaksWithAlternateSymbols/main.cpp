...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QString("ClassBreaksWithAlternateSymbols - QML"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Layers/ClassBreaksWithAlternateSymbols/ClassBreaksWithAlternateSymbols.qml"));
