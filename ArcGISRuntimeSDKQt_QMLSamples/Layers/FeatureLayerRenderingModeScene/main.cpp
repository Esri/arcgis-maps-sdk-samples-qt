...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName("FeatureLayerRenderingModeScene - QML");
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Layers/FeatureLayerRenderingModeScene/FeatureLayerRenderingModeScene.qml"));
