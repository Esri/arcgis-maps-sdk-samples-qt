...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName("FeatureLayer_FeatureService - QML");
  ...
  // Initialize application view
    ...
    // Set the source
    view.setSource(QUrl("qrc:/Samples/Features/FeatureLayer_FeatureService/FeatureLayer_FeatureService.qml"));
