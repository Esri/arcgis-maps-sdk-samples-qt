...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName("DistanceMeasurementAnalysis - QML");
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Analysis/DistanceMeasurementAnalysis/DistanceMeasurementAnalysis.qml"));
