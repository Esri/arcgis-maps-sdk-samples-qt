...
Rectangle {
    ...
    readonly property url dataPath: System.writableLocationPathUrl(System.StandardPathsHomeLocation) + "/ArcGIS/Runtime/Data/tpkx/"
    ...
    MapView {
        ...
        Component.onCompleted: {
            ...
            forceActiveFocus();
            setViewpointGeometryAndPadding(tourPath.extent, 100);
        }
    ...
    RouteTask {
        ...
        onCreateDefaultParametersStatusChanged: {
            ...
            stop1.geometry = tourPath.parts.part(0).startPoint();
            stop2.geometry = tourPath.parts.part(0).endPoint();
            ...
            createDefaultParametersResult.setStops([stop1, stop2]);
