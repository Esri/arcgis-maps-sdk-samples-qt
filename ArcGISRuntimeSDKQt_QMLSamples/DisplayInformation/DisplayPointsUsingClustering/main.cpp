...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QString("DisplayPointsUsingClusteringFeatureReduction - QML"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/DisplayInformation/DisplayPointsUsingClusteringFeatureReduction/DisplayPointsUsingClusteringFeatureReduction.qml"));
