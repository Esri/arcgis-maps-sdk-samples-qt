...
int main(int argc, char *argv[])
{
  ...
  const QString apiKey = QString("AAPK918f6836e4b341aa805749ffbcc12e7eoSANd5O6Lz-I8QbsHbGk4lSKtGnsgqeJpEiWSA7O8kXxhP2LU4OrEG9fLo_HqHzZ");
  if (apiKey.isEmpty())
  {
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/DisplayInformation/ShowCallout/ShowCallout.qml"));
