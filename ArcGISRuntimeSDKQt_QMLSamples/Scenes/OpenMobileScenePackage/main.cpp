...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QStringLiteral("OpenMobileScenePackage - QML"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Scenes/OpenMobileScenePackage/OpenMobileScenePackage.qml"));
