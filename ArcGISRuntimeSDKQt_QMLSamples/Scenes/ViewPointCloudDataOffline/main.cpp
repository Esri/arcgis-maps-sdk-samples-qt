...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QStringLiteral("ViewPointCloudDataOffline - QML"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Scenes/ViewPointCloudDataOffline/ViewPointCloudDataOffline.qml"));
