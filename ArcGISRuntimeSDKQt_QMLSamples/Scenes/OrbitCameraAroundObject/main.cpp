...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QStringLiteral("OrbitCameraAroundObject - QML"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Scenes/OrbitCameraAroundObject/OrbitCameraAroundObject.qml"));
