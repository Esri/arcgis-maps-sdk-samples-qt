...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QStringLiteral("ChooseCameraController - QML"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Scenes/ChooseCameraController/ChooseCameraController.qml"));
