...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QStringLiteral("ChangeAtmosphereEffect - QML"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Scenes/ChangeAtmosphereEffect/ChangeAtmosphereEffect.qml"));
