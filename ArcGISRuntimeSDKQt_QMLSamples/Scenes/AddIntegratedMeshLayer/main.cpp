...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QStringLiteral("AddIntegratedMeshLayer - QML"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Scenes/AddIntegratedMeshLayer/AddIntegratedMeshLayer.qml"));
