...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QString("FilterFeaturesInSceneView - C++"));
  ...
  FilterFeaturesInSceneView::init();
  ...
  // Set the source
  engine.load(QUrl("qrc:/Samples/Scenes/FilterFeaturesInSceneView/main.qml"));
