...
`
install_name_tool -change libEsriCommonQt.dylib "~/ArcGIS_SDKs/Qt100.7/sdk/macOS/x64/lib/libEsriCommonQt.dylib" Release/OAuthRedirectExample.app/Contents/MacOS/OAuthRedirectExample
`
