...
{
  ArcGISTiledLayer* gardenMap = new ArcGISTiledLayer(QUrl("https://arcgisruntime.maps.arcgis.com/home/item.html?id=b27ff1dd5f704970b38b676488c56494"), this);
...
QString Geotriggers::sectionName() const
{
  return m_sectionName;
}

QString Geotriggers::sectionDesc() const
{
