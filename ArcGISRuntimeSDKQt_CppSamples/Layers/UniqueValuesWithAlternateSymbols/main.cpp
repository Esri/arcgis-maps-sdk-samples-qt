...
#include "UniqueValuesWithAlternateSymbols.h"
...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QString("UniqueValuesWithAlternateSymbols - C++"));
  ...
  UniqueValuesWithAlternateSymbols::init();
  ...
  // Set the source
  engine.load(QUrl("qrc:/Samples/Layers/UniqueValuesWithAlternateSymbols/main.qml"));
