...
int main(int argc, char *argv[])
{
  ...
  const QString apiKey = "AAPKc56d587fc6774b2fb4d866c50b227bdeHgve6W4_2bXsjC6IkMHLmB0P5uyhjnrPmA42Ce3qm2IQbqWz2aLlaFFUAvwcxpjt";
  if (apiKey.isEmpty())
  {
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/LocalServer/LocalServerGeoprocessing/LocalServerGeoprocessing.qml"));
