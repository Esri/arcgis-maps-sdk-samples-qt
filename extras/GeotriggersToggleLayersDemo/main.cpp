...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QString("GeotriggersToggleLayersDemo - C++"));
  ...
  GeotriggersToggleLayersDemo::init();
  ...
  // Set the source
  engine.load(QUrl("qrc:/Samples/Analysis/GeotriggersToggleLayersDemo/main.qml"));
