...
int main(int argc, char *argv[])
{
  ...
  qmlRegisterType<MapQuickView>("Esri.GeotriggersDemo", 1, 0, "MapView");

  // Register the GeotriggersDemo (QQuickItem) for QML
  qmlRegisterType<GeotriggersDemo>("Esri.GeotriggersDemo", 1, 0, "GeotriggersDemo");
