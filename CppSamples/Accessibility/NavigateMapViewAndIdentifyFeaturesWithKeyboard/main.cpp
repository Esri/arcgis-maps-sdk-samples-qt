...
int main(int argc, char* argv[])
{
  ...
  app.setApplicationName(QString("NavigateMapViewAndIdentifyFeaturesWithKeyboard"));
  ...
  // Set the source
  engine.load(QUrl("qrc:/Samples/Accessibility/NavigateMapViewAndIdentifyFeaturesWithKeyboard/main.qml"));
