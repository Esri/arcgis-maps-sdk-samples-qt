...
int main(int argc, char *argv[])
{
  ...
  app.setApplicationName(QString("EditGeometriesWithProgrammaticReticleTool"));
  ...
  // Set the source
  engine.load(QUrl("qrc:/Samples/EditData/EditGeometriesWithProgrammaticReticleTool/main.qml"));
