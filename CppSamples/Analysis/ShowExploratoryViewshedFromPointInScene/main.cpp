...
int main(int argc, char* argv[])
{
  ...
  app.setApplicationName(QString("ShowExploratoryViewshedFromPointInScene"));
  ...
  // Set the source
  view.setSource(QUrl("qrc:/Samples/Analysis/ShowExploratoryViewshedFromPointInScene/ShowExploratoryViewshedFromPointInScene.qml"));
