...
#ifndef ShowExploratoryViewshedFromPointInScene_H
#define ShowExploratoryViewshedFromPointInScene_H
...
class ShowExploratoryViewshedFromPointInScene : public QQuickItem
{
  Q_OBJECT

public:
  explicit ShowExploratoryViewshedFromPointInScene(QQuickItem* parent = nullptr);
  ~ShowExploratoryViewshedFromPointInScene() override = default;
...
#endif // ShowExploratoryViewshedFromPointInScene_H
