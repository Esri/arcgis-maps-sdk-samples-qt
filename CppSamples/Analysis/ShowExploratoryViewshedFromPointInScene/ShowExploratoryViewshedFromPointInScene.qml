...
ShowExploratoryViewshedFromPointInSceneSample {
    id: viewshedSample
    clip: true
    width: 800
    height: 600
    ...
    SceneView {
        ...
        ToolButton {
            ...
            padding: 0
            icon {
                source: "qrc:/Samples/Analysis/ShowExploratoryViewshedFromPointInScene/gear-24.svg"
                width: 32
                height: 32
                ...
                Column {
                    ...
                    Item {
                        ...
                        ToolButton {
                            ...
                            display: AbstractButton.IconOnly
                            icon {
                                source: "qrc:/Samples/Analysis/ShowExploratoryViewshedFromPointInScene/x-24.svg"
                                width: 32
                                height: 32
                                color: hovered ? palette.buttonText : palette.text
                            }
