...
int main(int argc, char* argv[])
{
  ...
  app.setApplicationName(QString("ShowInteractiveViewshedWithAnalysisOverlay"));
  ...
  // Set the source
  engine.load(QUrl("qrc:/Samples/Analysis/ShowInteractiveViewshedWithAnalysisOverlay/main.qml"));
