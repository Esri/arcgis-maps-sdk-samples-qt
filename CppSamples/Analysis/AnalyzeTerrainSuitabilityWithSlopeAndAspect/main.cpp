...
int main(int argc, char* argv[])
{
  ...
  app.setApplicationName(QString("AnalyzeTerrainSuitabilityWithSlopeAndAspect"));
  ...
  engine.load(QUrl("qrc:/Samples/Analysis/AnalyzeTerrainSuitabilityWithSlopeAndAspect/main.qml"));
