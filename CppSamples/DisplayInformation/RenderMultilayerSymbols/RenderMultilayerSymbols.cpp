...
void RenderMultilayerSymbols::addPointGraphicsWithMarkerSymbols(GraphicsOverlay* overlay)
{
  ...
  VectorMarkerSymbolLayer* diamondVectorMarkerLayer =
    new VectorMarkerSymbolLayer(QList<VectorMarkerSymbolElement*>{diamondVectorMarkerElement}, this);
  ...
  VectorMarkerSymbolLayer* triangleVectorMarkerLayer =
    new VectorMarkerSymbolLayer(QList<VectorMarkerSymbolElement*>{triangleVectorMarkerElement}, this);
...
void RenderMultilayerSymbols::addPolygonGraphicsWithMarkerSymbols(GraphicsOverlay* overlay)
{
  ...
  MultilayerPolygonSymbol* diagonalCrossPolygonSymbol =
    new MultilayerPolygonSymbol(QList<SymbolLayer*>{diagonalStroke1, diagonalStroke2, strokeForOutline}, this);
...
void RenderMultilayerSymbols::addComplexPointGraphic(GraphicsOverlay* overlay)
{
  ...
  VectorMarkerSymbolElement* orangeSquareVectorElement =
    new VectorMarkerSymbolElement(orangeSquareGeometry, new MultilayerPolygonSymbol(QList<SymbolLayer*>{orangeFillLayer, pinkOutline}, this), this);
  VectorMarkerSymbolLayer* orangeSquareVectorMarkerLayer =
    new VectorMarkerSymbolLayer(QList<VectorMarkerSymbolElement*>{orangeSquareVectorElement}, this);
  ...
  VectorMarkerSymbolLayer* blackSquareVectorMarkerLayer =
    new VectorMarkerSymbolLayer(QList<VectorMarkerSymbolElement*>{blackSquareVectorElement}, this);
  ...
  MultilayerPolygonSymbol* transparentPurpleOutlineSymbol =
    new MultilayerPolygonSymbol(QList<SymbolLayer*>{transparentFillLayer, purpleOutline}, this);
  ...
  VectorMarkerSymbolLayer* purpleSquareVectorMarkerLayer =
    new VectorMarkerSymbolLayer(QList<VectorMarkerSymbolElement*>{purpleSquareVectorElement}, this);
  ...
  const Geometry hexagonElementGeometry =
    Geometry::fromJson(R"({"rings":[[[-2.89,5.0],[2.89,5.0],[5.77,0.0],[2.89,-5.0],[-2.89,-5.0],[-5.77,0.0],[-2.89,5.0]]]})"); // Hexagon geometry
  ...
  MultilayerPointSymbol* pointSymbol = new MultilayerPointSymbol(
    QList<SymbolLayer*>{hexagonVectorMarkerLayer, orangeSquareVectorMarkerLayer, blackSquareVectorMarkerLayer, purpleSquareVectorMarkerLayer}, this);
...
void RenderMultilayerSymbols::addComplexPolygonGraphic(GraphicsOverlay* overlay)
{
  ...
  MultilayerPolygonSymbol* polygonSymbol =
    new MultilayerPolygonSymbol(QList<SymbolLayer*>{redFillLayer, blackOutline, yellowStroke, blackDashes}, this);
