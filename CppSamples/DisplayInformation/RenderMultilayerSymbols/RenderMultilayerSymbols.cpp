...
void RenderMultilayerSymbols::addAllGraphics()
{
    ...
    textSymbol->setColor(QColor(Qt::black));
    textSymbol->setSize(20);
    textSymbol->setBackgroundColor(QColor(Qt::white));
    textSymbol->setOutlineColor(QColor(Qt::black));
...
void RenderMultilayerSymbols::addPointGraphicsWithMarkerSymbols(GraphicsOverlay* overlay)
{
    ...
    SolidFillSymbolLayer* vectorElementFill = new SolidFillSymbolLayer(QColor(Qt::red), this);
    ...
    vectorElementFill = new SolidFillSymbolLayer(QColor(Qt::red), this);
    ...
    SolidStrokeSymbolLayer* vectorElementStroke = new SolidStrokeSymbolLayer(1, QColor(Qt::red), this);
...
void RenderMultilayerSymbols::addLineGraphicsWithMarkerSymbols(GraphicsOverlay* overlay)
{
    ...
    strokeLayer = new SolidStrokeSymbolLayer(3, QColor(Qt::red), this);
...
void RenderMultilayerSymbols::addPolygonGraphicsWithMarkerSymbols(GraphicsOverlay* overlay)
{
    ...
    SolidStrokeSymbolLayer* strokeForHatches = new SolidStrokeSymbolLayer(2, QColor(Qt::red), this);
    SolidStrokeSymbolLayer* strokeForOutline = new SolidStrokeSymbolLayer(1, QColor(Qt::black), this);
...
void RenderMultilayerSymbols::addComplexPointGraphic(GraphicsOverlay* overlay)
{
    ...
    SolidStrokeSymbolLayer* pinkOutline = new SolidStrokeSymbolLayer(2, QColor(Qt::blue), this);
    ...
    SolidFillSymbolLayer* blackFillLayer = new SolidFillSymbolLayer(QColor(Qt::black), this);
    ...
    SolidFillSymbolLayer* transparentFillLayer = new SolidFillSymbolLayer(QColor(Qt::transparent), this);
    ...
    SolidFillSymbolLayer* yellowFillLayer = new SolidFillSymbolLayer(QColor(Qt::yellow), this);
    SolidStrokeSymbolLayer* blackOutline = new SolidStrokeSymbolLayer(2, QColor(Qt::black), this);
...
void RenderMultilayerSymbols::addComplexPolygonGraphic(GraphicsOverlay* overlay)
{
    ...
    SolidStrokeSymbolLayer* blackOutline = new SolidStrokeSymbolLayer(7, QColor(Qt::black), this);
    blackOutline->setCapStyle(StrokeSymbolLayerCapStyle::Round);

    // Create the yellow stroke inside
    SolidStrokeSymbolLayer* yellowStroke = new SolidStrokeSymbolLayer(5, QColor(Qt::yellow), this);
    yellowStroke->setCapStyle(StrokeSymbolLayerCapStyle::Round);

    // Symbol layers for multilayer polyline
    SolidStrokeSymbolLayer* blackDashes = new SolidStrokeSymbolLayer(1, QColor(Qt::black), this);
    DashGeometricEffect* dashEffect = new DashGeometricEffect(this);
    ...
    SolidFillSymbolLayer* redFillLayer = new SolidFillSymbolLayer(QColor(Qt::red), this);
