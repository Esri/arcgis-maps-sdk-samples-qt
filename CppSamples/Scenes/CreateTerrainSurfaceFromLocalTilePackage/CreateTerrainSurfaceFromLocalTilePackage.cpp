...
LocalSceneQuickView* CreateTerrainSurfaceFromLocalTilePackage::sceneView() const
{
  return m_sceneView;
}

// Set the view (created in QML)
void CreateTerrainSurfaceFromLocalTilePackage::setSceneView(LocalSceneQuickView* sceneView)
{
