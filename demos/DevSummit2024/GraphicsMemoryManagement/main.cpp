...
int main(int argc, char *argv[])
{
  ...
  qmlRegisterType<MapQuickView>("Esri.GraphicsMemoryManagement", 1, 0, "MapView");

  // Register the GraphicsMemoryManagement (QQuickItem) for QML
  qmlRegisterType<GraphicsMemoryManagement>("Esri.GraphicsMemoryManagement", 1, 0, "GraphicsMemoryManagement");
